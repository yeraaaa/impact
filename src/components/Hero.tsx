...
export default function Hero() {
    ...
    return (
        <>
            <div className='h-screen flex justify-center items-center text-center bg-gray-50 px-4'>
                <div className='flex flex-col md:flex-row justify-between items-center w-full max-w-6xl mt-8'>
                    <div className={`mb-16 md:w-1/2 ${buttonVisible ? 'animate-slide-in' : ''}`}>
                        <h3 className='text-lg sm:text-xl'>
                            Powered by Fertilitas Team
                        </h3>
                        <h1 className='md:text-6xl text-4xl tracking-tight mt-3 mb-3 font-extrabold'>
                            WITH YOU AT<br></br>
                        </h1>
                        <h1 className='md:text-6xl text-4xl tracking-tight mb-5 font-extrabold'>
                            <span className='text-[#ff1c19]'>EVERY STEP</span> 
                        </h1>
                        <button
                            onClick={openModal}
                            className='text-[#ff1c19] bg-white border-2 border-[#ff1c19] rounded-md px-6 font-medium py-2 hover:bg-[#ff1c19] hover:text-white transition-colors duration-300'
                        >
                            Apply Now
                        </button>
                    </div>
